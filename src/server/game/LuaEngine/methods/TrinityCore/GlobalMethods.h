...
namespace LuaGlobalFunctions
{
     ...
     *
     * Expansion is 0 for pre-TBC, 1 for TBC, 2 for WotLK, 3 for Cataclysm, and etc...
     *
    ...
    int GetObjectGUID(Eluna* E)
    {
        ...
        E->Push(ObjectGuid::Create<HighGuid::GameObject>(mapId, entry, lowguid));
        return 1;
    }
     ...
     * @param uint32 mapId : map ID of the [Creature]             <<< BFA, SL, DF
     * @return ObjectGuid guid
     */
    int GetUnitGUID(Eluna* E)
    {
        ...
        E->Push(ObjectGuid::Create<HighGuid::Creature>(mapId, entry, lowguid));
        return 1;
    }
    ...
    int GetAreaName(Eluna* E)
    {
        ...
        E->Push(areaEntry->AreaName.Str[locale]);
        return 1;
    }
    ...
    int PerformIngameSpawn(Eluna* E)
    {
        ...
        if (spawntype == 2) // Spawn object
        {
            ...
            if (!object->CreateGameObject(entry, map, Position(x, y, z, o), rot, 0, GO_STATE_READY))
            {
                delete object;
                E->Push();
                return 1;
